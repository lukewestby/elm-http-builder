...
var _user$project$HttpBuilder$appendQuery = F3(
...
var _user$project$HttpBuilder$replace = F2(
	function (old, $new) {
		return function (_p0) {
			return A2(
				_elm_lang$core$String$join,
...
var _user$project$HttpBuilder$queryEscape = function (_p1) {
	return A3(
		_user$project$HttpBuilder$replace,
		'%20',
		'+',
		_evancz$elm_http$Http$uriEncode(_p1));
};
var _user$project$HttpBuilder$queryPair = function (_p2) {
	var _p3 = _p2;
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$HttpBuilder$queryEscape(_p3._0),
		A2(
			_elm_lang$core$Basics_ops['++'],
			'=',
			_user$project$HttpBuilder$queryEscape(_p3._1)));
};
var _user$project$HttpBuilder$joinUrlEncoded = function (args) {
	return A2(
		_elm_lang$core$String$join,
		'&',
		A2(_elm_lang$core$List$map, _user$project$HttpBuilder$queryPair, args));
};
var _user$project$HttpBuilder$toSettings = function (_p4) {
	var _p5 = _p4;
	return _p5._1;
};
var _user$project$HttpBuilder$toRequest = function (_p6) {
	var _p7 = _p6;
	return _p7._0;
};
var _user$project$HttpBuilder$appendCacheBusterToUrl = F2(
	function (request, time) {
		return _elm_lang$core$Native_Utils.update(
			request,
			{
				url: A3(
					_user$project$HttpBuilder$appendQuery,
					request.url,
					'_',
					_elm_lang$core$Basics$toString(time))
			});
	});
var _user$project$HttpBuilder$jsonReader = F2(
...
var _user$project$HttpBuilder$stringReader = function (value) {
	var _p9 = value;
	if (_p9.ctor === 'Text') {
		return _elm_lang$core$Result$Ok(_p9._0);
	} else {
...
var _user$project$HttpBuilder$RequestBuilder = F3(
	function (a, b, c) {
		return {ctor: 'RequestBuilder', _0: a, _1: b, _2: c};
	});
var _user$project$HttpBuilder$requestWithVerbAndUrl = F2(
	function (verb, url) {
		return A3(
			_user$project$HttpBuilder$RequestBuilder,
			{
				verb: verb,
				url: url,
				headers: _elm_lang$core$Native_List.fromArray(
			...
			_user$project$HttpBuilder$defaultInternals);
	});
var _user$project$HttpBuilder$get = _user$project$HttpBuilder$requestWithVerbAndUrl('GET');
var _user$project$HttpBuilder$post = _user$project$HttpBuilder$requestWithVerbAndUrl('POST');
var _user$project$HttpBuilder$put = _user$project$HttpBuilder$requestWithVerbAndUrl('PUT');
var _user$project$HttpBuilder$patch = _user$project$HttpBuilder$requestWithVerbAndUrl('PATCH');
var _user$project$HttpBuilder$delete = _user$project$HttpBuilder$requestWithVerbAndUrl('DELETE');
var _user$project$HttpBuilder$mapRequest = F2(
...
var _user$project$HttpBuilder$withHeader = F2(
	function (key, value) {
		return _user$project$HttpBuilder$mapRequest(
			function (request) {
				return _elm_lang$core$Native_Utils.update(
					request,
					{
...
var _user$project$HttpBuilder$withHeaders = function (headers) {
	return _user$project$HttpBuilder$mapRequest(
		function (request) {
			return _elm_lang$core$Native_Utils.update(
				request,
...
var _user$project$HttpBuilder$withBody = function (body) {
	return _user$project$HttpBuilder$mapRequest(
		function (request) {
			return _elm_lang$core$Native_Utils.update(
				request,
...
var _user$project$HttpBuilder$withStringBody = function (_p12) {
	return _user$project$HttpBuilder$withBody(
		_evancz$elm_http$Http$string(_p12));
};
var _user$project$HttpBuilder$withJsonBody = function (_p13) {
	return _user$project$HttpBuilder$withStringBody(
		A2(_elm_lang$core$Json_Encode$encode, 0, _p13));
};
var _user$project$HttpBuilder$withUrlEncodedBody = function (_p14) {
	return _user$project$HttpBuilder$withStringBody(
		_user$project$HttpBuilder$joinUrlEncoded(_p14));
};
var _user$project$HttpBuilder$withMultipartBody = function (_p15) {
	return _user$project$HttpBuilder$withBody(
		_evancz$elm_http$Http$multipart(_p15));
};
var _user$project$HttpBuilder$withMultipartStringBody = function (_p16) {
	return _user$project$HttpBuilder$withMultipartBody(
		A2(
			_elm_lang$core$List$map,
			function (_p17) {
				var _p18 = _p17;
...
var _user$project$HttpBuilder$mapSettings = F2(
...
var _user$project$HttpBuilder$withTimeout = function (timeout) {
	return _user$project$HttpBuilder$mapSettings(
		function (settings) {
			return _elm_lang$core$Native_Utils.update(
				settings,
				{timeout: timeout});
...
var _user$project$HttpBuilder$withStartHandler = function (task) {
	return _user$project$HttpBuilder$mapSettings(
		function (settings) {
			return _elm_lang$core$Native_Utils.update(
				settings,
...
var _user$project$HttpBuilder$withProgressHandler = function (progressHandler) {
	return _user$project$HttpBuilder$mapSettings(
		function (settings) {
			return _elm_lang$core$Native_Utils.update(
				settings,
...
var _user$project$HttpBuilder$withMimeType = function (mimeType) {
	return _user$project$HttpBuilder$mapSettings(
		function (settings) {
			return _elm_lang$core$Native_Utils.update(
				settings,
...
var _user$project$HttpBuilder$withCredentials = _user$project$HttpBuilder$mapSettings(
	function (settings) {
		return _elm_lang$core$Native_Utils.update(
			settings,
			{withCredentials: true});
	});
var _user$project$HttpBuilder$mapInternals = F2(
...
var _user$project$HttpBuilder$withCacheBuster = _user$project$HttpBuilder$mapInternals(
	function (internals) {
		return _elm_lang$core$Native_Utils.update(
			internals,
			{cacheBuster: true});
...
var _user$project$HttpBuilder$Timeout = {ctor: 'Timeout'};
var _user$project$HttpBuilder$NetworkError = {ctor: 'NetworkError'};
var _user$project$HttpBuilder$promoteRawError = function (rawError) {
	var _p23 = rawError;
	if (_p23.ctor === 'RawTimeout') {
		return _user$project$HttpBuilder$Timeout;
	} else {
		return _user$project$HttpBuilder$NetworkError;
	}
};
var _user$project$HttpBuilder$UnexpectedPayload = function (a) {
	return {ctor: 'UnexpectedPayload', _0: a};
};
var _user$project$HttpBuilder$responseFromRaw = F2(
	function (reader, response) {
		...
		if (_p24.ctor === 'Ok') {
			...
			return _elm_lang$core$Task$fail(
				_user$project$HttpBuilder$UnexpectedPayload(_p24._0));
		}
	});
var _user$project$HttpBuilder$handleResponse = F4(
	function (successReader, errorReader, internals, response) {
		...
		return isSuccessful ? A2(_user$project$HttpBuilder$responseFromRaw, successReader, response) : A3(
			...
			function (_p25) {
				return _elm_lang$core$Task$fail(
					_user$project$HttpBuilder$BadResponse(_p25));
			},
			A2(_user$project$HttpBuilder$responseFromRaw, errorReader, response));
	});
var _user$project$HttpBuilder$sendHelp = F5(
	function (successReader, errorReader, internals, settings, request) {
		return A3(
			_elm_lang$core$Basics$flip,
			_elm_lang$core$Task$andThen,
			A3(_user$project$HttpBuilder$handleResponse, successReader, errorReader, internals),
			A2(
				_elm_lang$core$Task$mapError,
				_user$project$HttpBuilder$promoteRawError,
				A2(_evancz$elm_http$Http$send, settings, request)));
	});
var _user$project$HttpBuilder$send = F3(
	function (successReader, errorReader, _p26) {
		...
		return _p28.cacheBuster ? A3(
			_elm_lang$core$Basics$flip,
			_elm_lang$core$Task$andThen,
			A4(_user$project$HttpBuilder$sendHelp, successReader, errorReader, _p28, _p30),
			A2(
				_elm_lang$core$Task$map,
				_user$project$HttpBuilder$appendCacheBusterToUrl(_p29),
				_elm_lang$core$Time$now)) : A5(_user$project$HttpBuilder$sendHelp, successReader, errorReader, _p28, _p30, _p29);
	});
...
var _user$project$Tests$initialRequest = {
	verb: 'GET',
...
var _user$project$Tests$testDecoder = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['hello']),
	_elm_lang$core$Json_Decode$string);
var _user$project$Tests$toTuple = function (builder) {
	return {
		ctor: '_Tuple2',
		_0: _user$project$HttpBuilder$toRequest(builder),
		_1: _user$project$HttpBuilder$toSettings(builder)
	};
};
var _user$project$Tests$testProgressHandler = _elm_lang$core$Basics$always(
	_elm_lang$core$Task$succeed(
		{ctor: '_Tuple0'}));
var _user$project$Tests$testStartTask = _elm_lang$core$Task$succeed(
	{ctor: '_Tuple0'});
var _user$project$Tests$polyfillsEnabled = _user$project$Native_Polyfills.enabled;
var _user$project$Tests$all = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			'polyfills are set up',
			A2(_elm_community$elm_test$ElmTest$assertEqual, _user$project$Tests$polyfillsEnabled, true)),
			A2(
			_elm_community$elm_test$ElmTest$suite,
			'Request Building',
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					_elm_community$elm_test$ElmTest$test,
					'should build request and settings with expected params',
					A2(
						_elm_community$elm_test$ElmTest$assertEqual,
						{
							...
							_0: {
								...
								headers: _elm_lang$core$Native_List.fromArray(
									[
										{ctor: '_Tuple2', _0: 'OtherTest', _1: 'Header'},
										{ctor: '_Tuple2', _0: 'Test', _1: 'Header'}
									]),
								body: _evancz$elm_http$Http$string('{ \"test\": \"body\" }')
							},
							_1: {
								timeout: 10 * _elm_lang$core$Time$second,
								onStart: _elm_lang$core$Maybe$Just(_user$project$Tests$testStartTask),
								onProgress: _elm_lang$core$Maybe$Just(_user$project$Tests$testProgressHandler),
								desiredResponseType: _elm_lang$core$Maybe$Just('test/mime-type'),
								withCredentials: true
							}
						},
						_user$project$Tests$toTuple(
							_user$project$HttpBuilder$withCredentials(
								A2(
									_user$project$HttpBuilder$withMimeType,
									'test/mime-type',
									A2(
										_user$project$HttpBuilder$withProgressHandler,
										_user$project$Tests$testProgressHandler,
										A2(
											_user$project$HttpBuilder$withStartHandler,
											_user$project$Tests$testStartTask,
											A2(
												_user$project$HttpBuilder$withTimeout,
												10 * _elm_lang$core$Time$second,
												A2(
													_user$project$HttpBuilder$withStringBody,
													'{ \"test\": \"body\" }',
													A2(
														_user$project$HttpBuilder$withHeaders,
														_elm_lang$core$Native_List.fromArray(
															[
																{ctor: '_Tuple2', _0: 'OtherTest', _1: 'Header'}
															]),
														A3(
															_user$project$HttpBuilder$withHeader,
															'Test',
															'Header',
															_user$project$HttpBuilder$get('http://example.com'))))))))))))
				])),
			A2(
			_elm_community$elm_test$ElmTest$suite,
			'with*Body functions',
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					_elm_community$elm_test$ElmTest$test,
					'withStringBody applies string directly',
					A2(
						_elm_community$elm_test$ElmTest$assertEqual,
						_evancz$elm_http$Http$string('hello'),
						function (_) {
							return _.body;
						}(
							_user$project$HttpBuilder$toRequest(
								A2(
									_user$project$HttpBuilder$withStringBody,
									'hello',
									_user$project$HttpBuilder$get('http://example.com')))))),
					A2(
					_elm_community$elm_test$ElmTest$test,
					'withJsonBody applies a Json.Value as a string',
					A2(
						_elm_community$elm_test$ElmTest$assertEqual,
						_evancz$elm_http$Http$string('\"hello\"'),
						function (_) {
							...
							_user$project$HttpBuilder$toRequest(
								A2(
									_user$project$HttpBuilder$withJsonBody,
									_elm_lang$core$Json_Encode$string('hello'),
									_user$project$HttpBuilder$get('http://example.com')))))),
					A2(
					_elm_community$elm_test$ElmTest$test,
					'withUrlEncodedBody encodes pairs as url components',
					A2(
						_elm_community$elm_test$ElmTest$assertEqual,
						_evancz$elm_http$Http$string('hello=world&test=stuff'),
						function (_) {
							return _.body;
						}(
							_user$project$HttpBuilder$toRequest(
								A2(
									_user$project$HttpBuilder$withUrlEncodedBody,
									_elm_lang$core$Native_List.fromArray(
										[
											{ctor: '_Tuple2', _0: 'hello', _1: 'world'},
											{ctor: '_Tuple2', _0: 'test', _1: 'stuff'}
										]),
									_user$project$HttpBuilder$get('http://example.com')))))),
					A2(
					_elm_community$elm_test$ElmTest$test,
					'withMultipartBody passes through to Http.multipart',
					A2(
						_elm_community$elm_test$ElmTest$assertEqual,
						_evancz$elm_http$Http$multipart(
							_elm_lang$core$Native_List.fromArray(
								[
									A2(_evancz$elm_http$Http$stringData, 'hello', 'world')
								])),
						function (_) {
							return _.body;
						}(
							_user$project$HttpBuilder$toRequest(
								A2(
									_user$project$HttpBuilder$withMultipartBody,
									_elm_lang$core$Native_List.fromArray(
										[
											A2(_evancz$elm_http$Http$stringData, 'hello', 'world')
										]),
					...
					A2(
					_elm_community$elm_test$ElmTest$test,
					'withMultipartStringBody first converts string pairs to string data and then passes to multipart',
					A2(
						_elm_community$elm_test$ElmTest$assertEqual,
						_evancz$elm_http$Http$multipart(
							_elm_lang$core$Native_List.fromArray(
						...
						function (_) {
							...
							_user$project$HttpBuilder$toRequest(
								A2(
									_user$project$HttpBuilder$withMultipartStringBody,
									_elm_lang$core$Native_List.fromArray(
										[
											{ctor: '_Tuple2', _0: 'hello', _1: 'world'}
										]),
			...
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					_elm_community$elm_test$ElmTest$test,
					'should extract a text value as a string',
					A2(
						_elm_community$elm_test$ElmTest$assertEqual,
						_elm_lang$core$Result$Ok('test value'),
						_user$project$HttpBuilder$stringReader(
							_evancz$elm_http$Http$Text('test value')))),
					A2(
					_elm_community$elm_test$ElmTest$test,
					'should extract a json value with a decoder',
					A2(
						_elm_community$elm_test$ElmTest$assertEqual,
						_elm_lang$core$Result$Ok('world'),
						A2(
							_user$project$HttpBuilder$jsonReader,
							_user$project$Tests$testDecoder,
							_evancz$elm_http$Http$Text('{ \"hello\": \"world\" }'))))
				]))
		]));

var _user$project$Main$main = {
	main: _elm_community$elm_test$ElmTest$runSuite(_user$project$Tests$all)
};
